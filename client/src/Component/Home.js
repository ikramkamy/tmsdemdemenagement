    ...
    return (
        ...
        <div className="Home" >
            ...
            <div className="titleSlide">
                    ...
                    <h3>
        Une équipe de démènageurs expérimentés se chargera de votre démènagement.</h3>
...
<img src='./images/tmshome2.jpg' className='homewall2' alt="déménagement TMDEM"/> 
   ...
   <h1 className='animation_typing'>Un service client<br/> 24h/24 et 7j/7</h1>
<h4 >
Nous vous accompagnons avant, pendant et après votre démènagement. 
...
<div className="textFiled">
   ...
   <h2 className='animation_typing'>
    Avez-vous besoin des équipements de démènagement?</h2>
 ...
 <img src='./images/siteonlaptop.png' className='homewall2' alt="démènagement TMDEM"/> </div>
